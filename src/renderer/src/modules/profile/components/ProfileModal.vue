...
<template>
  <DialogRoot :open="props.open" @update:open="emit('update:open', $event)">
    <DialogPortal>
      <DialogOverlay class="bg-black/30 fixed inset-0 z-50 backdrop-blur-sm transition-all duration-300" />
      <DialogContent class="fixed top-[50%] left-[50%] max-h-[85vh] w-full max-w-[800px] translate-x-[-50%] translate-y-[-50%] rounded-[24px] bg-[var(--c-bg-app)] shadow-[0_12px_40px_rgba(0,0,0,0.12)] focus:outline-none z-50 overflow-y-auto flex flex-col sm:flex-row gap-6 p-6">
